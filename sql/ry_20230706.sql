...
insert into sys_menu values('4', '若依官网', '0', '4', 'http://easy1400.vip', null, '', 0, 0, 'M', '0', '0', '', 'guide',    'admin', sysdate(), '', null, '若依官网地址');
-- 二级菜单
...
INSERT INTO `sys_menu` (`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (2000, 'easy1400', 0, 1, 'viid', NULL, NULL, 1, 0, 'M', '0', '0', '', '#', 'admin', '2023-09-08 05:04:57', 'admin', '2023-09-08 05:05:27', '');
INSERT INTO `sys_menu` (`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (2001, '车辆查询', 2000, 1, 'viid/motorVehicleData', 'viid/data/motorVehicleData', NULL, 1, 1, 'C', '0', '0', '', '#', 'admin', '2023-09-08 05:07:10', 'admin', '2023-09-13 04:29:37', '');
INSERT INTO `sys_menu` (`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (2002, '人脸查询', 2000, 2, 'viid/faceData', 'viid/data/faceData', NULL, 1, 1, 'C', '0', '0', '', '#', 'admin', '2023-09-08 09:46:20', 'admin', '2023-09-13 04:29:34', '');
INSERT INTO `sys_menu` (`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (2003, '非机动车查询', 2000, 4, 'viid/nonMotorVehicleData', 'viid/data/nonMotorVehicleData', NULL, 1, 1, 'C', '0', '0', '', '#', 'admin', '2023-09-13 04:23:51', 'admin', '2023-09-13 04:47:40', '');
INSERT INTO `sys_menu` (`menu_id`, `menu_name`, `parent_id`, `order_num`, `path`, `component`, `query`, `is_frame`, `is_cache`, `menu_type`, `visible`, `status`, `perms`, `icon`, `create_by`, `create_time`, `update_by`, `update_time`, `remark`) VALUES (2004, '人员查询', 2000, 3, 'viid/personData', 'viid/data/personData', NULL, 1, 1, 'C', '0', '0', '', '#', 'admin', '2023-09-13 04:24:48', 'admin', '2023-09-13 04:42:22', '');
-- 用户管理按钮
